# -*- coding: utf-8 -*-
"""
Created on Fri May  8 16:44:44 2020
...
chunksize = 1000000 # set to 1 milion, just take all rows in a file (=450000)
headers = {
...
# This function has been marked as debugged, tested and meeth the definition of done.
# Function allows the user to insert the probe id's. The function approves the inserted
# probe_id with two different checks.
...
# used for the schematic workflow of the script
